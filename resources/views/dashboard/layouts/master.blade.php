...
<head>
    ...
    @include('dashboard.layouts.partials.head_style')
    @include('dashboard.layouts.partials.head_script')
</head>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                @include('dashboard.layouts.partials.sidebar_menu')
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
...
@include('dashboard.layouts.partials.body_script')
</body>
</html>
